...
+ block movement
  ...
  - []の中で]を入力すると，現在の]の末尾に飛ぶ.
+ Navigation
  - C-M-a: sp-beggining-of-sexp 現在のカッコの先頭へ移動.
  - C-M-e: sp-end-of-sexp現在のカッコの末尾へ移動.
  - C-M-d: sp-donw-sexp 現在のカッコのひとつ内側のカッコの先頭へ移動.
  - C-M-u: sp-up-sexp 現在のカッコのひとつ外側のカッコの末尾へ移動.
